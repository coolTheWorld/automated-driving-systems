...
**当前位置**：**P1 全部完成（S1–S5，CP-P1-A 与 CP-P1-B 均已通过）。下一步是 P2 控制（Stanley + PID）。**
CP-P1-B 已于 2026-08-01 由用户在 RViz 里肉眼确认：车道图、方向箭头、自车位置、点击出路径四项全部满足。
...
2. **采样步长 0.5 m 走的是参考线弧长 `s`，不是路径弧长。** 弯道外侧的实际点距
   ...
   但**前视距离不能用「往后数 N 个点」** —— 那在弯道上会短 14%，
   而 Stanley 对前视距离敏感。要按实际点距累加。
