...
> 　　**P9 感知域移植完成（2026-08-16：CP-P9-A/B/C/D/E 全达成，S5c 后 CARLA CP-P9-A 9/9 ×2、Gazebo CP-P5-B 9/9 ×3）；S5d 评估待拍板**
...
**P9 剩余唯一未决：S5d 做不做。** 窗口 6 实例仍在（用户拍板销毁）；产物 `.p9w4/w6/`。**
...
**接着做**：等 S5d 拍板 —— 做：拨一个云窗口跑「蠕动偏置 / 制动-滑行配平 / PI 复调」战役（尺子
`carla_throttle_map_probe.py --align`，开关 `ego.align_drivetrain`，判据 S01 四条）；不做：P9 收官，
维持 P8 入表放行。两条路都不碰 Gazebo。
