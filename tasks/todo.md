...
**当前位置**：**🚩 P2 控制完成 28/28，CP-P2-A 与 CP-P2-B 均已达成（2026-08-03）。**

**下一步需要你拍板一件事，然后才好定方向**：P0b（CARLA）接不接、怎么接 ——
材料见 [P2-S5 那节](#-55p0bcarla-决策材料2026-08-03等用户拍板)，
三个方案 A/B/C，我建议 **B（最小对齐验证）**，理由和它的前提都写在那里。

拍板之后：接 B/A 就去做 P0b；选 C 就直接进 **P3 规划（Frenet 采样）**。
...
| 5.5 | **P0b（CARLA）重新摆上桌面**：给出接入成本与不接的代价，交用户拍板 | 有可决策的材料 | ✅ 材料见下，**待用户拍板** |
