...
S5a RANSAC 100 A/B 落地（Gazebo 零劣化、ground_ms 8.1→3.1）、③ **已拍板：暂不动线程模型**（目标机
8.2 ms 在 SPEC §7 的 10 ms 内，WSL2 不是目标硬件；SPEC §7 注解）；S5b **✅【CP-P9-D】**（15 行全有自动化红绿）；S5c **✅ Gazebo 半区【CP-P9-E 半】**
